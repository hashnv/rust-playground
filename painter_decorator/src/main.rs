fn main() {
    ...
    let total_surface_area: f64 = (2.0 * room_height_meters * (wall_a_length_meters + wall_b_length_meters)) as f64;
    ...
    println!(
        ...
        paint_cans_required*paint_can_cost_gbp,
    );
    println!(
        "total_paint_can_cost_eur: {:.2} EUR",
        paint_cans_required*paint_can_cost_eur,
    );
}
